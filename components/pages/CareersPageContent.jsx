            ...
            {jobPostings.map((job) => (
              <div key={job.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="flex items-center text-gray-600 text-sm mb-4 space-x-4">
                  ...
                  <span className="flex items-center"><Calendar className="w-4 h-4 mr-1" /> Apply by {job.applicationDeadline ? format(new Date(job.applicationDeadline), "PPP") : "N/A"}</span>
                </div>
