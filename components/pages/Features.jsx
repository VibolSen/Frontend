...
export default function Features() {
  const features = [
    ...
    {
      icon: <GraduationCap className="w-12 h-12 text-slate-700" />,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-20 h-20 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-indigo-100/50">
                {feature.icon}
              </div>
