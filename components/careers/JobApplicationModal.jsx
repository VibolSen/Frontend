...
export default function JobApplicationModal({ isOpen, onClose, jobPostingId, jobTitle }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiClient.post("/careers/applications", formData);
      ...
      toast({
        ...
        description: error.response?.data?.error || error.message || "There was an error submitting your application. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsSubmitting(false);
