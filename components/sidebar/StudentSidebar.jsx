  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-indigo-600/5 to-transparent pointer-events-none" />
        ...
        >
          {!isCollapsed && (
            ...
            >
              <div className="h-10 w-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/20 rotate-3">
