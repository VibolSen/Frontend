...
import ManageGroupCourses from "./ManageGroupCourses";

export default function ManageGroupCoursesModal({
  isOpen,
  onClose,
  group,
  allCourses,
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-slate-400">
                  Assign or remove courses for <span className="text-indigo-600 font-bold">{group.name}</span>
                </p>
              </div>
            </div>
            <button 
