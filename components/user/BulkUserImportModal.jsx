          ...
          <div className="p-6 space-y-6">
            <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-xl flex gap-3">
              ...
              <div className="text-xs text-indigo-700 leading-relaxed">
                ...
                <p>Ensure your CSV has headers: <code className="bg-white/50 px-1 rounded">firstname, lastname, role, gender</code>. Role must be one of: HR, TEACHER, STUDENT, STUDY_OFFICE, FINANCE. Email and password will be automatically generated by the school.</p>
              </div>
            </div>
