...
import { X, TrendingDown, DollarSign, Calendar } from "lucide-react";
...
export default function ExpenseModal({ isOpen, expense, onClose, onExpenseSaved, showMessage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (expense) {
        await apiClient.put(`/financial/expenses/${expense.id}`, formData);
      } else {
        await apiClient.post("/financial/expenses", formData);
      }
