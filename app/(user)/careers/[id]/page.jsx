    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="flex flex-wrap items-center text-gray-600 text-sm mb-6 space-x-4">
          ...
          <span className="flex items-center"><Calendar className="w-4 h-4 mr-1" /> Posted: {jobPosting.postedDate ? format(new Date(jobPosting.postedDate), "PPP") : "N/A"}</span>
          <span className="flex items-center"><Clock className="w-4 h-4 mr-1" /> Apply by: {jobPosting.applicationDeadline ? format(new Date(jobPosting.applicationDeadline), "PPP") : "N/A"}</span>
        </div>
