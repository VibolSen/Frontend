...
const SubmissionRow = ({ submission, onGrade }) => {
  ...
  return (
    <tr className="bg-white border-b hover:bg-slate-50">
      <td className="px-6 py-4 font-medium text-gray-900">{`${submission.student?.firstName || 'Unknown'} ${submission.student?.lastName || ''}`}</td>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500">
          ...
          <span className="font-semibold">{exam.group?.name || 'N/A'}</span>
        </p>
      </div>
