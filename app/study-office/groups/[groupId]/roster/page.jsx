import ManageGroupMembersPage from "@/components/group/ManageGroupMembersPage";
...
export default async function GroupRosterPageRoute({ params }) {
  ...
  return <ManageGroupMembersPage group={group} allStudents={allStudents} role="study-office" />;
}
